...
plot_daily_activity_boxed = pn.Column(
    pn.pane.Markdown(
        "#### In this graph you see the activity over the lifespan of the mailing list. From this you can understand for how long the Working Group exists and how active it has been, and whether there have been any peeks in activity."
    ),
    plot_daily_activity,
)
...
plot_interactions_boxed = pn.Column(
    pn.pane.Markdown(
        "#### This graph shows the interaction among the post posters to the working group mailing list. It allows you to understand who sents the most mails, and to whom they are responding. The bigger the size of the node, the more emails they have sent. If you click on the node, you will see the emailaddress of the sender and the amount of emails they have sent"
    ),
    plot_interactions,
)
